...
export function HowToMade({}: IHowToMadeProps) {
  return (
    <>
      <div
        id="how-to-made"
        className="z-10 flex w-full flex-col items-center bg-white lg:h-[467px] lg:px-[160px] xl:h-[584px] xl:px-[200px] 2xl:h-[700px] 2xl:px-[240px] 3xl:h-[876px] 3xl:px-[300px]"
      >
